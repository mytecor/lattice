...
Фича: [F7 — LLM gateway](../features/f7-llm-gateway.md). Продолжает отрицательный Go LIP PoC
[f7-06](./f7-06-go-lip-gonka-cutover.md), завершает runtime-часть
[f7-02](./f7-02-declarative-gateway-service.md) и разблокирует
[f7-04](./f7-04-routing-resilience-tests.md) и [f8-02](./f8-02-pi-gateway-config.md).
