...
Фича: [F7 — LLM gateway](../features/f7-llm-gateway.md). Завершает runtime-часть cutover из
...
- [x] `docs/roadmap/tasks/f7-07-bifrost-go-proxy.md`: отметить пункт об удалении как выполненный.
